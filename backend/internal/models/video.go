...
func GetDefaultCategories() []Category {
	return []Category{
		...
		{Slug: "chastity", Name: "Chastity", Description: "Chastity play and orgasm control"},
		{Slug: "device-bondage", Name: "Device Bondage", Description: "Mechanical restraints and devices"},
		{Slug: "medical-bondage", Name: "Medical Bondage", Description: "Clinical restraint and medical fetish scenes"},
		{Slug: "vacbed", Name: "Vacbed", Description: "Vacuum bed bondage and enclosure fetish"},
