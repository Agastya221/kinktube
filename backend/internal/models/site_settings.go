...
func DefaultSiteSettings(cfg *config.Config) *SiteSettings {
	...
	settings := &SiteSettings{
		Branding: BrandingSettings{
			...
			HeroAccent:        "Extreme",
			HeroTitle:         "BDSM and Hardcore Fetish",
		...
		SEO: SEOSettings{
			SiteURL:              siteURL,
			DefaultTitle:         "KinkTube - Extreme BDSM and Hardcore Fetish Videos",
			...
			OpenGraphTitle:       "KinkTube - Extreme BDSM and Hardcore Fetish Videos",
			...
			TwitterTitle:         "KinkTube - Extreme BDSM and Hardcore Fetish Videos",
